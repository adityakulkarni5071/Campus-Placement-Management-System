...
?>
    <div class="col-md-9 main" style="width: 80%; padding-right: 20px">
        ...
        <div class="sign-up-form">
            ...
            <p id = "signup_instructions">Effortlessly connect employers with talent: Streamline your hiring process with our online placement management system. </p>
            <?php
                if($set_value==1){
            ...
            <form  id = "form" action="registration.php" method="post">
                <div class="sign-up">
                    ...
                    <div class="sign-u">
                        ...
                        <div class="sign-up2">
                                <input type="text" name="name" id="name" class="text" value="" placeholder="Full Name" required>
                    </div>
                    ...
                    <div class="sign-u">
                        ...
                        <div class="sign-up2">
                                <input type="email" name="email" class="text" id="input-email" value="" placeholder="Email Address" required>
                        </div>
                    ...
                    <div>
                        ...
                        <input type="submit" value="Submit" id="input-submit" style="display: inline-block">
